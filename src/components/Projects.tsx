        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group flex flex-col bg-surface rounded-2xl border border-border hover:border-primary shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden relative"
            >
              ...
              {/* Project Content */}
              <div className="p-8 flex flex-col flex-grow relative overflow-hidden bg-surface">
                ...
                <div className="mt-auto">
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.technologies.map(tech => (
                      <span key={tech} className="text-[10px] font-semibold text-muted bg-background border border-border rounded-md px-2 py-1">
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between border-t border-border pt-4 mt-4">
                    ...
                    <button className="text-xs font-bold text-muted hover:text-primary flex items-center group/btn transition-colors">
